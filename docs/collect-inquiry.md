# Consulta de recaudo en línea

Procesa una solicitud administrativa de consulta de recaudo en línea.
...
Código de transacción | Código de transacción de consulta de recaudo en línea predefinido por el API Evertec.
